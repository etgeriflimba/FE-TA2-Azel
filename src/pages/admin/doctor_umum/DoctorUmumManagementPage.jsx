...
const DoctorUmumManagementPage = () => {
  ...
  const fetchDoctors = async () => {
    try {
      ...
      const doctorResponse = await axiosInstance.get("/v1/admin/data/dokter-umum", {
        params: {
          per_page: 5,
  ...
  return (
    <AdminLayout
      title="Daftar Dokter Umum"
      rightSection={
        <Link to="/admin/doctor-umum/create">
            ...
            {doctors.map((doctor, index) => {
              return (
                <TableRow key={doctor.id}>
                  ...
                  <TableCell>
                    <Link to={"/admin/doctor-umum/edit/" + doctor.id}>
...
export default DoctorUmumManagementPage;
